...
class SuggestTopicBottomSheetDialog : BaseDialog<DialogSuggestTopicBinding, SuggestTopicViewModel>() {

    override val viewModel: SuggestTopicViewModel by viewModel()

    override fun initBinding(inflater: LayoutInflater) = DialogSuggestTopicBinding.inflate(inflater)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding.sendSuggestionButton.setOnClickListener { trySend() }
        binding.successView.dismissButton.setOnClickListener { dismiss() }
        binding.failedView.retryButton.setOnClickListener { trySend() }
    }
