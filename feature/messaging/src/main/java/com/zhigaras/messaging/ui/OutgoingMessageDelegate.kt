...
class OutgoingMessageDelegate : AdapterDelegate<Message.Outgoing, OutgoingMessageDelegate.OutgoingMessageViewHolder>() {
    ...
    override fun createViewHolder(parent: ViewGroup) = OutgoingMessageViewHolder(
